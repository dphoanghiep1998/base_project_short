...
import com.gianghv.libads.databinding.MlbViewGoogleBigNativeGiftLanguageBinding
import com.gianghv.libads.databinding.MlbViewGoogleBignativeBinding

class NativeAdGiftViewLanguage(context: Context, attrs: AttributeSet?) : MLBBaseNativeAdView(context, attrs) {

    var mViewBinding: MlbViewGoogleBigNativeGiftLanguageBinding =
        MlbViewGoogleBigNativeGiftLanguageBinding.inflate(LayoutInflater.from(context) , this , true)
