...
class FragmentOtherCall : Fragment() {
    ...
    private fun initRecyclerView() {
        val listData = mutableListOf(
            OtherCallModel(
                -1, R.drawable.ic_momo, R.drawable.ic_momo_circle, "Spooky Momo", R.raw.momo, "", 0
            ),
            OtherCallModel(
                -1, R.drawable.ic_nun, R.drawable.ic_nun_circle, "The Nun", R.raw.nun, "", 1
            ),
            OtherCallModel(
                -1,
                R.drawable.ic_wednesday,
                R.drawable.ic_wed_circle,
                "Wednesday",
                R.raw.wednesday,
                "",
                2
            ...
            OtherCallModel(
                -1, R.drawable.ic_mm, R.drawable.ic_mm_circle, "Mommy Long Leg", R.raw.mommy, "", 3
            ),
        )
